...
# CSV output on std out
./tractatus --github-org org-name --format csv

# CSV to file
./tractatus --github-org org-name --format csv --output inventory.csv
...
./tractatus --source aws --account gofan_prod --output ~/Documents/csv/aws/aws_file.csv
```
...
## Basic Mode
[ ] Flag: `--basic-mode`. Type: 'boolean', Default: `false`
[ ] Headers: `app-name`, `owner`, `repo-url`
[ ] Flag `--exclude-archived`. Type: 'boolean', Default: `true`
[ ] Perform collect process
[ ] Write to Confluence
[ ] `owner` is the sus one. Keep it blank on first run
